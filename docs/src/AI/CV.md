...
- 两阶段检测算法：
  - R-CNN 系列：[R-CNN](https://strongnine.github.io/9Docs/dev/AI/CV/#R-CNN)、[Fast R-CNN](https://strongnine.github.io/9Docs/dev/AI/CV/#Fast-R-CNN)、[Faster R-CNN](https://strongnine.github.io/9Docs/dev/AI/CV/#Faster-R-CNN)、Light-Hear R-CNN、Mask R-CNN
  - SPPNet
- 一阶段检测算法：
